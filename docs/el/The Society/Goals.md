...
- Συμμετέχοντας στην Πανευρωπαϊκή Ένωση Γεωγράφων ([European Association of Geographers - EUROGEO](https://www.eurogeography.eu/)) και στη Διεθνή Γεωγραφική Ένωση ([International Geographical Union (IGU) - IGU](https://igu-online.org/)) να προσφέρει στην επιστήμη της Γεωγραφίας.
